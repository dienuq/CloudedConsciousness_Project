# Instructions:
# replace esp8266_ip, pc_ip and tablet_ip
# paste ChatGPT API key in text.txt
...
client_leds = udp_client.SimpleUDPClient("es82866_ip", 8888) # replace esp8266_ip
client_proj = udp_client.SimpleUDPClient("pc_ip", 8889) # replace pc_ip
client_tablet = udp_client.SimpleUDPClient("tablet_ip", 12000) #replace tablet_ip
